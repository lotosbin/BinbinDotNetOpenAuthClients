...
namespace BinbinDotNetOpenAuth.AspNet.Clients
{
    ...
    ///     网易
    /// </summary>
    public class NeteaseWeiboClient : OAuth2Client
    {
        private static readonly ILog log = LogManager.GetLogger(typeof (NeteaseWeiboClient));
        ...
        public NeteaseWeiboClient(string clientId, string clientSecret)
        ...
        public NeteaseWeiboClient(string clientId, string clientSecret, params string[] requestedScopes)
            : base("neteaseweibo")
        {
